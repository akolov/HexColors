Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/akolov/HexColors'
  s.description = %{
  ...
  s.source = { :git => 'https://github.com/akolov/HexColors.git', :tag => s.version.to_s}
  s.ios.deployment_target = '8.0'
  s.osx.deployment_target = '10.9'
  s.watchos.deployment_target = '2.0'
  s.tvos.deployment_target = '9.0'
  s.source_files = 'Sources/HexColors/*.swift'
end
